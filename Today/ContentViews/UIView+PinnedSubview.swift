...
extension UIView {
    func addPinnedSubview(
        ...
        addSubview(subview)
        subview.translatesAutoresizingMaskIntoConstraints = false // Disable translatesAutoresizingMaskIntoConstraints to prevent the system from creating automatic constraints for this view.
